...
WORKER_4_MTR_SUITES="auth_sec,audit_log,audit_log_filter,binlog_57_decryption,percona-pam-for-mysql,data_masking,procfs,rpl_encryption,audit_null,engines/iuds,engines/funcs,group_replication,jp,stress"
